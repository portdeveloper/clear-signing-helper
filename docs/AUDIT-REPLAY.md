...
Fixed on 2026-09-26: items 1, 2, 3, 4 and 8 (and the metadata length limits beside item 4). Re-applying the Hyperliquid run's own decisions file with the fix and exporting took upstream lint from 7 warnings to 3; both runners passed.
